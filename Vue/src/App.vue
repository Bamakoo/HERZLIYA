...
//   { value: 'scienceFiction', icon: '', name: 'Science-Fiction', to: '/science_fiction' },
//   { value: 'action', icon: '', name: 'Action', to: '/action' },
//   { value: 'horror', icon: '', name: 'Horreur', to: '/horror' },
//   { value: 'biography', icon: '', name: 'Biographie', to: '/biography' }
// ]
